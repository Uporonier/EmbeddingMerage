...
alpha = 0.8  # Weight for the first model
beta = 0.2   # Weight for the second model

# Combine embeddings with weights
combined_embeddings = alpha * embeddings_A + beta * embeddings_B_projected

# Step 5: 替换并保存
model_A.model.embed_tokens.weight = nn.Parameter(combined_embeddings)
output_path = 'D:\\desktop\\merage\\models\\meraged\\llamaWeightSum82'
